...
{
    // here i semulate the in memory data instead of use the acualy database 
    public class EmployeeManagementTestDataRepository : IEmployeeManagementRepository
    {
        ...
        public EmployeeManagementTestDataRepository()
        {
            ...
            _externalEmployees = new()
            {
                ...
                new ExternalEmployee("Moudy", "Rasmy","Test Compony IT")
                {
                    Id = Guid.NewGuid()
                }
            };
        ...
        public bool DeleteInternelEmployee(Guid employeeId)
        {
            ...
            var employee = GetInternalEmployee(employeeId);
            var result =  _internalEmployees.Remove(employee);
            return result;
            }
            catch
            {
